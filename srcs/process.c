...
/*   Updated: 2018/01/25 11:42:21 by scornaz          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void		init_infos(t_infos *infos, t_list *list, int *flags)
{
	...
	infos->dirs[0] = "";
	infos->max_gw = ft_lstgetmax(list, 0, get_max_gw, flags);
	infos->max_usr = ft_lstgetmax(list, 0, get_max_usr, flags);
